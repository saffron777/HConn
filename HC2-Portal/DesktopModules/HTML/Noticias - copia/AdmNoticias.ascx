...
<div style="padding: 15px 15px 15px 15px">
                    ...
                    <MasterTableView CommandItemDisplay="Top" Width="100%" NoMasterRecordsText="No se encontraron registros" AllowAutomaticDeletes="True">
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="IdNoticia" 
                                FilterControlAltText="Filtrar columna Id" HeaderText="Id" UniqueName="Id" 
                                Display="False">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Thumbnail" UniqueName="thumb_image">
                                <ItemTemplate>
    ...
    <asp:Panel ID="PanelPublicacion" runat="server">
        <table id="TablaPublicacion" class="FuentePublicacion" cellspacing="0" cellpadding="0" width="100%" runat="server">
            ...
            <tr>
                <td style="width: 130px; vertical-align: top" class="SubTitulosPublicacion">Fecha:</td>
                <td style="width: 5px;">&nbsp;</td>
                <td style="vertical-align: top;">
                    <table width="100%">
                        <tr>
                            ...
                            <td class="SubTitulosPublicacion" style="padding-bottom: 5px; width: 120px;">Vencimiento:</td>
            ...
            <tr>
                ...
                <td style="text-align: center;">
                    <telerik:RadButton ID="btnGuardar" runat="server" onclick="btnGuardar_Click" text="Guardar publicación" validationgroup="vgNoticias" width="160px">
                    </telerik:RadButton>
                    &nbsp;
