...
<script type="text/javascript">
    ...
    function ListaRedes(sender, args) {
      ...
      var Activo1 = $find("<%= IndActivo_01.ClientID %>");
      var Activo2 = $("#<%= IndActivo_02.ClientID%>");
                        ...
                        <tr>
                            ...
                            <td>
                              <table>
								...
								<tr>
									<td style="width:5px;"><asp:RadioButton runat="server" ID="IndActivo_02" ClientIDMode="Static" Checked="True" GroupName="IndActivo"  /></td>
									<td>No </td>
								</tr>
                              </table>
                            </td>
