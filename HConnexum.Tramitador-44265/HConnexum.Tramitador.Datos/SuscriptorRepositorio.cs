...
{
	///<summary>Clase: SuscriptorRepositorio.</summary>	
	public sealed class SuscriptorRepositorio : RepositorioBase<Suscriptor>
	{
		#region "ConstructoreS"
		
		///<summary>Constructor de la clase SuscriptorRepositorio.</summary>
		///<param name="udt">Unidad de trabajo.</param>
		public SuscriptorRepositorio(IUnidadDeTrabajo udt) : base(udt)
		{
		}
        ...
        public DataSet IndicarExisteProveedorReporteRemesa(int idSuscriptor)
        {
            ...
            if (dslista.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in dslista.Tables[0].Rows)
                {
                    ...
                    var tabUsuariosSuscriptor = udt.Sesion.CreateObjectSet<UsuariosSuscriptor>();
