...
{
    ///<summary>Interface: PasosBloqueMetadata.</summary>
    internal interface IPasosBloqueMetadata
    {
        [Required]
        [Integer]
        int Id { get; set; }
    ...
    ///<summary>Clase: PasosBloque.</summary>
    [MetadataType(typeof(IPasosBloqueMetadata))]
    public partial class PasosBloque : IPasosBloqueMetadata
    {
