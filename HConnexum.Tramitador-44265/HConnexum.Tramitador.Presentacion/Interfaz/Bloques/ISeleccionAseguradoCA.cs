...
{
	/// <summary>Interfaz del control Web de usuario 'SeleccionAseguradoCA'.</summary>
	public interface ISeleccionAseguradoCA : InterfazBaseBloques
	{
		...
		string TitularCedulaNumero { get; set; }
		...
		DateTime? TitularNacimientoFecha { get; set; }
		...
		string BeneficiarioCedulaNumero { get; set; }
		...
		IEnumerable<ListasValorDTO> ListaHospitalizacionDias { set; }
