...
{
	///<summary>Interface DocumentosServicioLista.</summary>
    public interface IDocumentosServicioLista: InterfazBase
	{
        int IdFlujoServicio { get; }
		///<summary>Propiedad para asignar el datasource al RadGrid.</summary>
		IEnumerable<DocumentosServicioDTO> Datos { set; }
