...
{
	///<summary>Clase AlcanceGeograficoPresentadorLista.</summary>
    public class AlcanceGeograficoPresentadorLista : PresentadorListaBase<AlcanceGeografico>
    {
		///<summary>Variable vista de la interfaz IAlcanceGeograficoLista.</summary>
        IAlcanceGeograficoLista vista;
		
		///<summary>Constructor de la clase.</summary>
        ///<param name="vista">Variable tipo Interfaz de la vista.</param>
        public AlcanceGeograficoPresentadorLista(IAlcanceGeograficoLista vista)
        {
            this.vista = vista;
        ...
        public void MostrarVista(string orden, int pagina, int tamañoPagina, IList<Infraestructura.Filtro> parametrosFiltro)
        {
			try
			{
	            AlcanceGeograficoRepositorio repositorio = new AlcanceGeograficoRepositorio(unidadDeTrabajo);
                IEnumerable<AlcanceGeograficoDTO> datos = repositorio.ObtenerDTOconTodo(orden, pagina, tamañoPagina, parametrosFiltro);
        ...
        public void Eliminar(IList<string> ids)
        {
			try
			{
	            ...
	            foreach(string id in ids)
	            {
	                ...
	                AlcanceGeografico _AlcanceGeografico = repositorio.ObtenerPorId(idDesencriptado);
	                if(!repositorio.EliminarLogico(_AlcanceGeografico, _AlcanceGeografico.Id))
                        this.vista.Errores = "Ya Existen registros asociados a esta  _" + _AlcanceGeografico + "";
	            }
        ...
        {
            AlcanceGeograficoRepositorio repositorio = new AlcanceGeograficoRepositorio(this.unidadDeTrabajo);
        ...
        public void activarEliminado(IList<string> ids)
        {
            try
            {
                ...
                {
                    int idDesencriptado = int.Parse(System.Text.Encoding.UTF8.GetString(HttpServerUtility.UrlTokenDecode(id.ToString())).Desencriptar());
                    AlcanceGeografico _Aplicacion = repositorio.ObtenerPorId(idDesencriptado);
