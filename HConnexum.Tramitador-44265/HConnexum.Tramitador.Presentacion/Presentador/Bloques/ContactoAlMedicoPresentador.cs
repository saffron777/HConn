...
{
	public class ContactoAlMedicoPresentador : BloquesPresentadorBase
	{
		readonly IContactoAlMedico vista;

		///<summary>Constructor de la clase.</summary>
		///<param name="vista">Variable tipo Interfaz de la vista.</param>
		public ContactoAlMedicoPresentador(IContactoAlMedico vista)
		{
			this.vista = vista;
		}
		...
		public void LlenarCombo()
		{
			try
			{
				vista.ComboMedicoContacto = ObtenerListaValor(WebConfigurationManager.AppSettings[@"ListaDecisionSimple"]);
			}
			catch(Exception e)
			{
