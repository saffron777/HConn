...
{
	public class RegistrodeOpinionMedicoPresentadorDetalle : BloquesPresentadorBase
	{
		readonly IRegistrodeOpinionMedico vista;

		///<summary>Constructor de la clase.</summary>
		///<param name="vista">Variable tipo Interfaz de la vista.</param>
		public RegistrodeOpinionMedicoPresentadorDetalle(IRegistrodeOpinionMedico vista)
		{
			this.vista = vista;
		}
