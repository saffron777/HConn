...
{
	public class SeguimientoCitaPresentador : BloquesPresentadorBase
	{
		readonly ISeguimientoCita vista;

		public SeguimientoCitaPresentador(ISeguimientoCita vista)
		{
			this.vista = vista;
		}
		...
		public void LlenarCombo()
		{
			...
			vista.ComboCita = ObtenerListaValor(WebConfigurationManager.AppSettings["ListaDecisionSimple"]);
		}
	}
}