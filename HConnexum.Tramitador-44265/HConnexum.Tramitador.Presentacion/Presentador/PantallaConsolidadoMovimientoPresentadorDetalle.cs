...
{
	public class PantallaConsolidadoMovimientoPresentadorDetalle : PresentadorDetalleBase<Caso>
	{
		///<summary>Variable vista de la interfaz IPantallaConsolidadoMovimientosUsuario.</summary>
		readonly IPantallaConsolidadoMovimiento vista;

		readonly UnidadDeTrabajo udt = new UnidadDeTrabajo();

		public PantallaConsolidadoMovimientoPresentadorDetalle(IPantallaConsolidadoMovimiento vista)
		{
			this.vista = vista;
