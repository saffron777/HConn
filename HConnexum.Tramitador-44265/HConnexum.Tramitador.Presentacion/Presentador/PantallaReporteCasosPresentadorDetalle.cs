...
{
	public class PantallaReporteCasosPresentadorDetalle : PresentadorDetalleBase<Caso>
	{
		///<summary>Variable vista de la interfaz IReporteCasos.</summary>
		IPantallaReporteCasos vista;

		UnidadDeTrabajo udt = new UnidadDeTrabajo();

		public PantallaReporteCasosPresentadorDetalle(IPantallaReporteCasos vista)
		{
			this.vista = vista;
