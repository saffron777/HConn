...
{
	public class ReporteCartaAvalMIPresentadorDetalle : PresentadorDetalleBase<Caso>
	{
		readonly IReporteCartaAvalMI vista;
		readonly UnidadDeTrabajo udt = new UnidadDeTrabajo();

		public ReporteCartaAvalMIPresentadorDetalle(IReporteCartaAvalMI vista)
		{
			this.vista = vista;
		}
		...
		public IEnumerable<ReporteCartaAvalMIDTO> GenerarConsultaReporte(int idCarta, int idSuscriptor)
		{
		...
		public IEnumerable<ReporteCartaAvalMIDTO> ConversionDatasetToIEnumerable(DataSet dataSetColeccion)
		{
			var iEnumerableColeccion = (from TabDatosgestor in dataSetColeccion.Tables["DatosPaciente"].AsEnumerable()
										select new ReporteCartaAvalMIDTO
										{
