...
{
	public class ReporteConsolidadoMovimientoPresentadorDetalle: PresentadorDetalleBase<Caso>
	{
		///<summary>Variable vista de la interfaz IReporteCasos.</summary>
		readonly IReporteConsolidadoMovimiento vista;
		readonly UnidadDeTrabajo udt = new UnidadDeTrabajo();

		public ReporteConsolidadoMovimientoPresentadorDetalle(IReporteConsolidadoMovimiento vista)
		{
			this.vista = vista;
