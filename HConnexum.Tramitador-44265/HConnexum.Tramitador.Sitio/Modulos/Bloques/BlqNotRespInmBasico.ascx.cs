...
{
	public partial class BlqNotRespInmBasico : UserControlBase, IBlqNotRespInmBasico
	{
		BlqNotRespInmBasicoPresentador presentador;
		...
		protected void Page_Init(object sender, EventArgs e)
		{
			try
			{
				...
				this.presentador = new BlqNotRespInmBasicoPresentador(this);
			}
			catch(Exception ex)
			{
