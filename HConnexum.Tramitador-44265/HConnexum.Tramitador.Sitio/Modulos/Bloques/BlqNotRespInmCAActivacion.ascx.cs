...
{
	public partial class BlqNotRespInmCAActivacion : UserControlBase, IBlqNotRespInmCAActivacion
	{
		BlqNotRespInmCAActivacionPresentador presentador;
		...
		protected void Page_Init(object sender, EventArgs e)
		{
			try
			{
				...
				this.presentador = new BlqNotRespInmCAActivacionPresentador(this);
			}
			catch(Exception ex)
			{
		...
		protected void Page_PreRender(object sender, EventArgs e)
		{
			try
			{
				...
				if(MostrarImprimir)
					btnImprimir.Enabled = MostrarImprimir;
        ...
        {
            get { return IdSupportIncident.Value; }
            set { IdSupportIncident.Value = value; }
        }
