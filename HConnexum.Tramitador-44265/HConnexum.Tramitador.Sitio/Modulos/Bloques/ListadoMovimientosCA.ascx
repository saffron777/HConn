<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListadoMovimientosCA.ascx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Bloques.ListadoMovimientosCA" %>
<telerik:RadGrid ID="RadGridMaster" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="0" GridLines="None" AllowCustomPaging="false" AllowPaging="false" AllowSorting="True" OnSortCommand="RadGridMaster_SortCommand" OnNeedDataSource="RadGridMaster_NeedDataSource" AllowFilteringByColumn="false">
