<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SolicitudNuevoMovimiento_ExtEgrCA.ascx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Bloques.SolicitudNuevoMovimiento_ExtEgrCA" %>
	...
	<table runat="server" id="T2" border="0" width="100%" class="ancho">
		...
		<tr>
            <td style="vertical-align: top; width: 50%" colspan="2">
                <asp:CustomValidator runat="server" ID="cvDocumentos" ClientValidationFunction="ValidarDocumentos" ErrorMessage="* &nbsp; &nbsp; Debe seleccionar y enviar al menos un documento." Width="100%" CssClass="validator" ValidationGroup="Validaciones"/>
            </td>
		</tr>
        <tr>
	    ...
	    <tr>
            <td style="vertical-align: top; width: 50%"><asp:TextBox ID="ObservacionesDocumentos" runat="server" MaxLength="200" TextMode="MultiLine" Rows="5" Width="100%" Style="overflow:auto"/><br/></td>
