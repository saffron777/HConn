...
{
	public partial class SolicitudNuevoMovimiento_ExtEgrCA : UserControlBase, ISolicitudNuevoMovimientoCA
	{
		...
		protected void NomTipoMov_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
		{
			...
			{
				#region GUI
				mostrar = (NomTipoMov.SelectedValue != presentador.MovimientoEgresoAnulacionId);
				...
				#endregion
				if(NomTipoMov.SelectedValue == presentador.MovimientoExtensionId)
				{
					ULTIMOTIPOMOV.Value = ParametrosEntrada[@"TIPOMOV"];
					this.TipoMov.Value = "EXTENSIÓN";
				}
				else if(NomTipoMov.SelectedValue == presentador.MovimientoEgresoId)
				{
					ULTIMOTIPOMOV.Value = ParametrosEntrada[@"TIPOMOV"];
					this.TipoMov.Value = "EGRESO";
				}
				else if(NomTipoMov.SelectedValue == presentador.MovimientoEgresoAnulacionId)
				{
					ULTIMOTIPOMOV.Value = ParametrosEntrada[@"TIPOMOV"];
