<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SolicitudNuevoMovimiento_IngCA.ascx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Bloques.SolicitudNuevoMovimiento_IngCA" %>
	...
	<table runat="server" id="T1" border="0" width="100%" class="ancho">
		...
		<tr>
			<td class="labelCell4colP" style="vertical-align: top;">
				...
				<asp:Label ID="lblObservacion2" runat="server" Text="Observaciones/ Anulaci&oacute;n" Visible="False" />
				<asp:Label ID="lblObservacionActivacion" runat="server" Text="Observaciones" Visible="False" />
			</td>
		...
		<tr>
			<td class="fieldCell4colP" style="vertical-align: top;">
				...
				<asp:TextBox ID="ObsDiagnosticoActivacion" runat="server" MaxLength="200" TextMode="MultiLine" Rows="5" Width="83%" Visible="False" Style="overflow:auto"/>
			</td>
	...
	<table runat="server" id="Table1" border="0" width="100%" class="ancho">
		...
		<tr>
            <td style="vertical-align: top; width: 50%" colspan="2">
                <asp:CustomValidator runat="server" ID="CustomValidator1" ClientValidationFunction="ValidarDocumentos" ErrorMessage="* &nbsp; &nbsp; Debe seleccionar y enviar al menos un documento." Width="100%" CssClass="validator" ValidationGroup="Validaciones"/>
            </td>
		</tr>
        <tr>
	    ...
	    <tr>
            <td style="vertical-align: top; width: 50%"><asp:TextBox ID="TextBox1" runat="server" MaxLength="200" TextMode="MultiLine" Rows="5" Width="100%" />
                <br/>
            </td>
...
<telerik:RadInputManager ID="RadInputManager1" runat="server" >
	...
	<telerik:NumericTextBoxSetting BehaviorID="BehaviorNumeric" Validation-IsRequired="true" ErrorMessage="Campo Obligatorio" DecimalDigits="2" DecimalSeparator="," Validation-ValidationGroup="Validaciones">
		<TargetControls>
...
<!-- CLAVES XML-FIN -->
<span class="arrange"><asp:HiddenField runat="server" ID="hidBloqueTipo" Value="IngresoCA" /></span>
