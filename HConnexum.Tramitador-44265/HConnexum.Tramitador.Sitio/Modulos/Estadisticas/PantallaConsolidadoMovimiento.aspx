<%@ Page Title="Consolidado de Movimientos por Usuario" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="PantallaConsolidadoMovimiento.aspx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Estadisticas.PantallaConsolidadoMovimiento" %>
...
<telerik:RadScriptBlock runat="server" ID="RadScriptBlock2">
	...
	<asp:Panel ID="ReporteConsolidadoMovimientosUsuario" runat="server" Width="80%" GroupingText="Consolidado de Movimientos por Usuario">
		<table>
			<tr>
				<td >
