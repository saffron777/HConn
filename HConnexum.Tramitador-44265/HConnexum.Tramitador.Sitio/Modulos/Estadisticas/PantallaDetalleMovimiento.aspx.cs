...
{
	public partial class PantallaDetalleMovimiento : PaginaDetalleBase, IPantallaDetalleMovimiento
	{
		#region "Variables Locales"
		///<summary>Variable presentador ReporteConsolidadoMovimientosUsuarios.</summary>
		PantallaDetalleMovimientoPresentador presentador;
		#endregion "Variables Locales"

		#region "Propiedades Presentación"
		...
		#endregion "Propiedades Presentación"
		...
		protected void Page_Init(object sender, EventArgs e)
		{
			try
			{
				...
				presentador = new PantallaDetalleMovimientoPresentador(this);
		...
		protected void ddlProveedor_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
		{
		...
		protected void ButtonProcesar_Click(object sender, EventArgs e)
		{
			...
			url.Append(@"~/Modulos/Estadisticas/ReporteDetalleMovimiento.aspx?IdMenu=");
