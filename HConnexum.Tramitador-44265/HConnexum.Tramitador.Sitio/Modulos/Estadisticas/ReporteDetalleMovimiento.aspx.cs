...
{
	public partial class ReporteDetalleMovimiento : PaginaBase, IReporteDetalleMovimiento
	{
		...
		protected void Page_Init(object sender, EventArgs e)
		{
			try
			{
				...
				ReporteDetalleMovimientoPresentador presentador = new ReporteDetalleMovimientoPresentador(this);
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				if (!IsPostBack)
				{
					DisenoReporteDetalleMovimiento report = new DisenoReporteDetalleMovimiento();
		...
		public IEnumerable<ReporteMovimientoDTO> LlenarReporteDetalleMovimiento(int? idSuscriptor, int? idSucursal, int? idServicio, int? idarea, int? idproveedor, int? idusuario, int? idpais, int? iddivterr1, int? iddivterr2, int? iddivterr3, DateTime? fechaDesde, DateTime? fechaHasta)
		{
			ReporteDetalleMovimientoPresentador presentador = new ReporteDetalleMovimientoPresentador(this);
