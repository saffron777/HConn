...
namespace HConnexum.Tramitador.Sitio.Modulos.Estructura
{
    ...
    public partial class AgrupacionLista : PaginaListaBase, IAgrupacionLista
    {
        ///<summary>Variable presentador AgrupacionPresentadorLista.</summary>
        AgrupacionPresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                presentador = new AgrupacionPresentadorLista(this);
                Orden = "Id";
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<HConnexum.Tramitador.Negocio.Agrupacion> Datos
        {
            set
            {
