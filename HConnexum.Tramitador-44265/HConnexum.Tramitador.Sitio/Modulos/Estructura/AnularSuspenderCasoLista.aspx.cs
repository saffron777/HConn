...
namespace HConnexum.Tramitador.Sitio.Modulos.Estructura
{
    ...
    public partial class AnularSuspenderCasoLista : PaginaListaBase, IAnularSuspenderCasoLista
    {
        ///<summary>Variable presentador CasoPresentadorLista.</summary>
        AnularSuspenderCasoPresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                presentador = new AnularSuspenderCasoPresentadorLista(this);
                Orden = "Id";
            }
            catch (Exception ex)
            {
        ...
        protected void RadGridMaster_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {                   
                this.presentador.MostrarVista(this.Orden, this.NumeroPagina, this.TamanoPagina, this.ParametrosFiltro,  UsuarioActual.SuscriptorSeleccionado.Id);
            }
            catch (Exception ex)
            {
                HConnexum.Infraestructura.Errores.ManejarError(ex, @"Error al Mostrar la data de la Aplicacion");
