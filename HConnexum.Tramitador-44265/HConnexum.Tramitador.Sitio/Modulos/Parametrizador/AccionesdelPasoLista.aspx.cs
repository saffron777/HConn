...
namespace HConnexum.Tramitador.Sitio.Modulos.Parametrizador
{
    ...
    public partial class AccionesdelPasoLista : PaginaMaestroDetalleBase, IAccionesDelPasoLista
    {
		///<summary>Variable presentador FlujosEjecucionPresentadorLista.</summary>
        AccionesDelPasoPresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
		 	try
            {
                ...
                presentador = new AccionesDelPasoPresentadorLista(this);
	            Orden = "Id";
			}
            catch (Exception ex)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
			try
            {
	            ...
	            if(!IsPostBack)
	            {
                    ...
                    {
                        this.Session.Add("Id", this.Id);
                    }
                    else
                    {
                        this.Session["Id"] = this.Id;
                    }
                    presentador.ServicioParametrizador();
                    presentador.LlenarTextBox();
                    NumeroPagina = 1;
        ...
        public IEnumerable<FlujosEjecucionDTO> Datos
        {
            set
            {
        ...
        {
            get { return txtEstatus.Text; }
            set { txtEstatus.Text = value; }
        }
