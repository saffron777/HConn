...
namespace HConnexum.Tramitador.Sitio
{
    ...
    public partial class AlcanceGeograficoLista : PaginaMaestroDetalleBase, IAlcanceGeograficoLista
    {
		///<summary>Variable presentador AlcanceGeograficoPresentadorLista.</summary>
        AlcanceGeograficoPresentadorLista presentador;
        int IdFlujoServicio;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
		 	try
            {
	            ...
	            presentador = new AlcanceGeograficoPresentadorLista(this);
	            Orden = "Id";
			}
            catch (Exception ex)
            {
        ...
        public IEnumerable<AlcanceGeograficoDTO> Datos
        {
            set
            {
