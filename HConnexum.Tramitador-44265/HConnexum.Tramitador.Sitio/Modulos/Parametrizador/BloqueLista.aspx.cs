...
namespace HConnexum.Tramitador.Sitio.Modulos.Parametrizador
{
    ...
    public partial class BloqueLista : PaginaListaBase, IBloqueLista
    {
        ///<summary>Variable presentador BloquePresentadorLista.</summary>
        BloquePresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                presentador = new BloquePresentadorLista(this);
                Orden = "Id";
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<Bloque> Datos
        {
            set
            {
