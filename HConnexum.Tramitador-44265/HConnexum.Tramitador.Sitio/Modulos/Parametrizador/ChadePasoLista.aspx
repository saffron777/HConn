<%@ Page Title="Listado de CHA del Paso" MasterPageFile="~/Master/Site.Master" Language="C#" AutoEventWireup="True" CodeBehind="ChadePasoLista.aspx.cs" Inherits="HConnexum.Tramitador.Sitio.ChadePasoLista" meta:resourcekey="PageResource1" %>
        ...
        <div style="position: relative; width: 100%; height: 100%; bottom: 0; left: 0; z-index: 1">
            <telerik:RadScriptBlock runat="server" id="RadScriptBlock1">
                <script type="text/javascript">
                    ...
                    var ventanaDetalle = "Modulos/Parametrizador/ChadePasoDetalle.aspx?IdMenu=" + idMenu + "&";
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtServicio" runat="server" ReadOnly="True" Width="250"
                                     meta:resourcekey="txtServicioResource1" ></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lblEstatus" runat="server" Text="Estat&acuteus:" 
                                   meta:resourcekey="lblEstatusResource1"/>
                    </td>
                    <td>
                        <asp:TextBox ID="txtEstatus" runat="server" ReadOnly="True" Width="250"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtEtapa" runat="server" ReadOnly="True" Width="250"
                                     meta:resourcekey="txtEtapaResource1" ></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lblVersion" runat="server" ReadOnly="True" 
                                   meta:resourcekey="lblVersionResource1"/>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVersion" runat="server" ReadOnly="True" Width="250"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPaso" runat="server" ReadOnly="True" Width="250"
                                     meta:resourcekey="txtPasoResource1"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <telerik:RadGrid id="RadGridMaster" runat="server" autogeneratecolumns="False" width="100%"
                ...
                <MasterTableView CommandItemDisplay="Top" NoMasterRecordsText="No se encontraron registros" DataKeyNames="IdEncriptado" ClientDataKeyNames="IdEncriptado" width="100%">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="NombreCargo" 
                                                 FilterControlAltText="Filtrar columna IdCargosuscriptor" 
                                                 DataFormatString="{0:N0}" HeaderText="Cargo Suscriptor" 
                                                 UniqueName="IdCargosuscriptor" meta:resourcekey="GridBoundColumnResource2"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="NombreHabilidad" 
                                                 FilterControlAltText="Filtrar columna IdHabilidadSuscriptor" 
                                                 DataFormatString="{0:N0}" HeaderText="Habilidad Suscriptor" 
                                                 UniqueName="IdHabilidadSuscriptor" 
                                                 meta:resourcekey="GridBoundColumnResource3"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="NombreAutonomia" 
                                                 FilterControlAltText="Filtrar columna IdAutonomiaSuscriptor" 
                                                 DataFormatString="{0:N0}" HeaderText="Autonomia Suscriptor" 
                                                 UniqueName="IdAutonomiaSuscriptor" 
                        ...
                        <telerik:GridBoundColumn DataField="FechaValidez" FilterControlAltText="Filter column column" 
                                                 HeaderText="Fecha Validez" UniqueName="column" DataFormatString= "{0:d}" 
                                    ...
                                    <telerik:RadToolBar ID="RadToolBar1"  
                                        ...
                                        <Items>
                                            ...
                                            <telerik:RadToolBarButton runat="server" Text="Ver Detalle" 
                                                                      ...
                                                                      ImagePosition="Right"  ImageUrl="~/Imagenes/icon_lupa18x18.png" 
                                            ...
                                            <telerik:RadToolBarButton runat="server" CommandName="Add" Text="Agregar" 
                                                                      ...
                                                                      ImageUrl="~/Imagenes/AddRecord.gif" meta:resourcekey="RadToolBarButtonResource4" 
                                                                      Owner="">
                                            </telerik:RadToolBarButton>                 
                                            <telerik:RadToolBarButton runat="server" CommandName="Edit" ImagePosition="Right" PostBack="False"
