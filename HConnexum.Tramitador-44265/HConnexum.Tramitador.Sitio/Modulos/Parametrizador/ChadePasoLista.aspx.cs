...
namespace HConnexum.Tramitador.Sitio
{
    ...
    public partial class ChadePasoLista : PaginaMaestroDetalleBase, IChadePasoLista
    {
        ///<summary>Variable presentador ChadePasoPresentadorLista.</summary>
        ChadePasoPresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                presentador = new ChadePasoPresentadorLista(this);
                Orden = "Id";
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<ChadePasoDTO> Datos
        {
            set
            {
