<%@ Page Title="Listado de Documentos Pasos" Language="C#" MasterPageFile="~/Master/Site.Master"  AutoEventWireup="True" CodeBehind="DocumentosPasoLista.aspx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Parametrizador.DocumentosPasoLista" meta:resourcekey="PageResource1" %>
    ...
    <div style="position: relative; width: 100%; height: 100%; bottom: 0; left: 0; z-index: 1">
        <telerik:RadScriptBlock runat="server" id="RadScriptBlock1">
            <script type="text/javascript">
                ...
                var ventanaDetalle = "Modulos/Parametrizador/DocumentosPasoDetalle.aspx?IdMenu=" + idMenu + "&";
        ...
        <telerik:RadGrid id="RadGridMaster" runat="server" autogeneratecolumns="False" width="100%"
            ...
            <MasterTableView CommandItemDisplay="Top" NoMasterRecordsText="No se encontraron registros" DataKeyNames="IdEncriptado" ClientDataKeyNames="IdEncriptado" width="100%">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="DocumentoServicio" 
                                             FilterControlAltText="Filtrar columna IdDocumentoServicio" 
                                             DataFormatString="{0:N0}" HeaderText="Documento" 
                                             UniqueName="IdDocumentoServicio" meta:resourcekey="GridBoundColumnResource2"></telerik:GridBoundColumn>
        ...
        <telerik:RadWindow id="RadWindow1" runat="server" height="350px"
            ...
            <ContentTemplate>
                <fieldset>
                    <legend>
                        <asp:Label ID="Label1" runat="server" Text="Busqueda Avanzada" 
