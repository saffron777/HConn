...
namespace HConnexum.Tramitador.Sitio.Modulos.Parametrizador
{
    ...
    public partial class DocumentosPasoLista : PaginaMaestroDetalleBase, IDocumentosPasoLista
    {
        ///<summary>Variable presentador DocumentosPasoPresentadorLista.</summary>
        DocumentosPasoPresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                presentador = new DocumentosPasoPresentadorLista(this);
                Orden = "Id";
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<DocumentosPasoDTO> Datos
        {
            set
            {
