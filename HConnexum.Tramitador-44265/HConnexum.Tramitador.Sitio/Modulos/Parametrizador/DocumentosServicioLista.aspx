<%@ Page Language="C#" MasterPageFile="~/Master/Site.Master" TItle="Lista de Documentos Servicio" AutoEventWireup="True" CodeBehind="DocumentosServicioLista.aspx.cs" Inherits="HConnexum.Tramitador.Sitio.DocumentosServicioLista" meta:resourcekey="PageResource1" %>
    ...
    <div style="position: relative; width: 100%; height: 100%; bottom: 0; left: 0; z-index: 1">
        <telerik:RadScriptBlock runat="server" id="RadScriptBlock1">
            <script type="text/javascript">
                ...
                var ventanaDetalle = "Modulos/Parametrizador/DocumentosServicioDetalle.aspx?IdMenu=" + idMenu + "&";
        ...
        <telerik:RadGrid id="RadGridMaster" runat="server" autogeneratecolumns="False" width="100%"
            ...
            <ClientSettings EnableRowHoverStyle="true">
                ...
                <ClientEvents OnRowDblClick="ShowMessage"></ClientEvents>
            ...
            <MasterTableView CommandItemDisplay="Top" NoMasterRecordsText="No se encontraron registros" DataKeyNames="IdEncriptado" ClientDataKeyNames="IdEncriptado" width="100%">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="Nombre" 
                                             FilterControlAltText="Filtrar columna IdDocumento" DataFormatString="{0:N0}" 
                                             HeaderText="IdDocumento" UniqueName="IdDocumento" 
                                             meta:resourcekey="GridBoundColumnResource2"></telerik:GridBoundColumn>
                    <telerik:GridCheckBoxColumn DataField="IndDocObligatorio" 
                                                FilterControlAltText="Filtrar columna IndDocObligatorio"  
                                                HeaderText="IndDocObligatorio" UniqueName="IndDocObligatorio" 
                                                meta:resourcekey="GridCheckBoxColumnResource1"></telerik:GridCheckBoxColumn>
                    <telerik:GridCheckBoxColumn DataField="IndVisibilidad" 
                                                FilterControlAltText="Filtrar columna IndVisibilidad"  
                                                HeaderText="IndVisibilidad" UniqueName="IndVisibilidad" 
                                                meta:resourcekey="GridCheckBoxColumnResource2"></telerik:GridCheckBoxColumn>
                    <telerik:GridCheckBoxColumn DataField="IndVigente" 
                                                FilterControlAltText="Filtrar columna IndVigente"  HeaderText="IndVigente" 
                                                UniqueName="IndVigente" meta:resourcekey="GridCheckBoxColumnResource3"></telerik:GridCheckBoxColumn>
        ...
        <telerik:RadWindow id="RadWindow1" runat="server" height="350px"
            ...
            <ContentTemplate>
                <fieldset>
                    <legend>
                        <asp:Label ID="lblBusquedaAvanzada" runat="server" Text="Busqueda Avanzada" 
