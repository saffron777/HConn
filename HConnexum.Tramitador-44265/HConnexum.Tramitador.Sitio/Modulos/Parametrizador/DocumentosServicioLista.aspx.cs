...
namespace HConnexum.Tramitador.Sitio
{
    ...
    public partial class DocumentosServicioLista : PaginaMaestroDetalleBase, IDocumentosServicioLista
    {
		///<summary>Variable presentador DocumentosServicioPresentadorLista.</summary>
        DocumentosServicioPresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
		 	try
            {
	            ...
	            presentador = new DocumentosServicioPresentadorLista(this);
	            Orden = "Id";
			}
            catch (Exception ex)
            {
        ...
        public IEnumerable<DocumentosServicioDTO> Datos
        {
            set
            {
