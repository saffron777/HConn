...
namespace HConnexum.Tramitador.Sitio.Modulos.Parametrizador
{
    ...
    public partial class FlujosEjecucionLista : PaginaListaBase, IFlujosEjecucionLista
    {
		///<summary>Variable presentador FlujosEjecucionPresentadorLista.</summary>
        FlujosEjecucionPresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
		 	try
            {
	            ...
	            presentador = new FlujosEjecucionPresentadorLista(this);
	            Orden = "Id";
			}
            catch (Exception ex)
            {
        ...
        public IEnumerable<FlujosEjecucion> Datos
        {
            set
            {
