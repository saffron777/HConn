...
{
	///<summary>Clase ParametrosAgendaLista.</summary>
	public partial class ParametrosAgendaDetalle : PaginaDetalleBase, IParametrosAgendaDetalle
	{
		#region "Variables Locales"
		///<summary>Variable presentador ParametrosAgendaPresentadorDetalle.</summary>
		ParametrosAgendaPresentadorDetalle presentador;
		...
		protected void Page_Init(object sender, EventArgs e)
		{
			try
			{
				...
				presentador = new ParametrosAgendaPresentadorDetalle(this);
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				if(!Page.IsPostBack)
				{
					RutaPadreEncriptada = @"/" + Request.Url.Segments[1].Substring(0, Request.Url.Segments[1].Length - 1) + ArbolPaginas.ObtenerArbolPaginaPadre().UrlRedirect;
		...
		public string Paso
		{
			get { return txtPaso.Text; }
			set { txtPaso.Text = value; }
		}

		public string KeyFechaEjec
		{
			get { return txtKeyFechaEjec.Text; }
			set { txtKeyFechaEjec.Text = value; }
		}

		public string KeyHoraEjec
		{
			get { return txtKeyHoraEjec.Text; }
			set { txtKeyHoraEjec.Text = value; }
		}
		...
		public string Cantidad
		{
			get
			{
				return this.txtCantidad.CantidadTotalEnSegundos.ToString();
			}
			set
			{
				this.txtCantidad.CantidadTotalEnSegundos = value;
			}
		}

		public string IndInmediato
		{
			get
			{
				return chkIndInmediato.Checked.ToString();
			}
			set
			{
				chkIndInmediato.Checked = ExtensionesString.ConvertirBoolean(value);
			}
		}
