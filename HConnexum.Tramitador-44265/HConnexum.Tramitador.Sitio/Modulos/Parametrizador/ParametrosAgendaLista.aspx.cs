...
namespace HConnexum.Tramitador.Sitio.Modulos.Parametrizador
{
    ...
    public partial class ParametrosAgendaLista : PaginaMaestroDetalleBase, IParametrosAgendaLista
    {
		///<summary>Variable presentador ParametrosAgendaPresentadorLista.</summary>
        ParametrosAgendaPresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
		 	try
            {
	            ...
	            presentador = new ParametrosAgendaPresentadorLista(this);
	            Orden = "Id";
			}
            catch (Exception ex)
            {
        ...
        public IEnumerable<ParametrosAgendaDTO> Datos
        {
            set
            {
