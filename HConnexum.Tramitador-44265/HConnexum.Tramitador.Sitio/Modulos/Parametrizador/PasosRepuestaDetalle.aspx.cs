...
{
	///<summary>Clase PasosRepuestaLista.</summary>
    public partial class PasosRepuestaDetalle : PaginaDetalleBase, IPasosRepuestaDetalle
    {
        #region "Variables Locales"
		///<summary>Variable presentador PasosRepuestaPresentadorDetalle.</summary>
        PasosRepuestaPresentadorDetalle presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
			try
            {
	            ...
	            presentador = new PasosRepuestaPresentadorDetalle(this);
        ...
        {
            get { return txtValorRespuesta.Text; }
            set { txtValorRespuesta.Text = value; }
        }
		...
		{
            get { return int.Parse(txtSecuencia.Text); }
            set { txtSecuencia.Text = value.ToString(); }
		}
