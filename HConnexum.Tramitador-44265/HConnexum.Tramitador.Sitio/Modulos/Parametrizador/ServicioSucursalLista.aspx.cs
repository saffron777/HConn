...
namespace HConnexum.Tramitador.Sitio.Modulos.Parametrizador
{
    ...
    public partial class ServicioSucursalLista : PaginaMaestroDetalleBase, IServicioSucursalLista
    {
        ///<summary>Variable presentador ServicioSucursalPresentadorLista.</summary>
        ServicioSucursalPresentadorLista presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                presentador = new ServicioSucursalPresentadorLista(this);
                Orden = "Id";
            }
            catch (Exception ex)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                RadFilterMaster.Culture = Thread.CurrentThread.CurrentCulture;
        ...
        protected void RadGridMaster_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                presentador.MostrarVista(Orden, NumeroPagina, TamanoPagina, ParametrosFiltro, this.Id);
            }
            catch (Exception ex)
            {
                HConnexum.Infraestructura.Errores.ManejarError(ex, @"Error al Mostrar la data de la Aplicacion");
        ...
        public IEnumerable<ServicioSucursalDTO> Datos
        {
            set
            {
