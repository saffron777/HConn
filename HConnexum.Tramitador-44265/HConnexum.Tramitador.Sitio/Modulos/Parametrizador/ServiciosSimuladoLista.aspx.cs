...
namespace HConnexum.Tramitador.Sitio
{
	...
	public partial class ServiciosSimuladoLista : PaginaMaestroDetalleBase, IServiciosSimuladoLista
	{
		///<summary>Variable presentador ServiciosSimuladoPresentadorLista.</summary>
		ServiciosSimuladoPresentadorLista presentador;
		...
		protected void Page_Init(object sender, EventArgs e)
		{
			try
			{
				...
				presentador = new ServiciosSimuladoPresentadorLista(this);
				Orden = "Id";
			}
			catch(Exception ex)
			{
        ...
        public IEnumerable<ServiciosSimuladoDTO> Datos
		{
			set
			{
