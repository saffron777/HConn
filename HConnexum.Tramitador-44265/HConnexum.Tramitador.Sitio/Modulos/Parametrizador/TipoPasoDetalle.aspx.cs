...
namespace HConnexum.Tramitador.Sitio.Modulos.Parametrizador
{
    ...
    public partial class TipoPasoDetalle : HConnexum.Tramitador.Sitio.PaginaDetalleBase, ITipoPasoDetalle
    {
        #region "Variables Locales"
        ///<summary>Variable presentador TipoPasoPresentadorDetalle.</summary>
        TipoPasoPresentadorDetalle presentador;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                presentador = new TipoPasoPresentadorDetalle(this);
        ...
        public string Programa
        {
            get
            {
                return txtPrograma.Text;
            }
            set
            {
                txtPrograma.Text = value;
            }
        }
