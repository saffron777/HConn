<%@ Page Title="Tipo Paso Lista"  Language="C#" AutoEventWireup="True" MasterPageFile="~/Master/Site.Master" CodeBehind="TipoPasoLista.aspx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Parametrizador.TipoPasoLista" meta:resourcekey="PageResource1" %>
		...
		<div style="position: relative; width: 100%; height: 100%; bottom: 0; left: 0; z-index: 1">
		    <telerik:RadScriptBlock runat="server" id="RadScriptBlock1">
		        <script type="text/javascript">
                    	...
                    	var ventanaDetalle = "Modulos/Parametrizador/TipoPasoDetalle.aspx?IdMenu=" + idMenu + "&";
		        ...
		        <MasterTableView CommandItemDisplay="Top" NoMasterRecordsText="No se encontraron registros" DataKeyNames="IdEncriptado" ClientDataKeyNames="IdEncriptado" width="100%">
		          ...
		          <Columns>
		            ...
		            <telerik:GridBoundColumn DataField="Descripcion" 
                          FilterControlAltText="Filtrar columna Descripcion"  HeaderText="Descripción" 
                          UniqueName="Descripcion" meta:resourcekey="GridBoundColumnResource2"></telerik:GridBoundColumn>
		            <telerik:GridBoundColumn DataField="Programa" 
                          FilterControlAltText="Filtrar columna Programa"  HeaderText="Programa" 
                          UniqueName="Programa" meta:resourcekey="GridBoundColumnResource3"></telerik:GridBoundColumn>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
		    ...
		    <telerik:RadWindow id="RadWindow1" runat="server" height="350px"
		        ...
		        <ContentTemplate>
		            <fieldset>
		                <legend><asp:Label ID="lgLegendBusquedaAvanzada" runat="server" 
                                Text="Busqueda Avanzada" Font-Bold="True" 
                                meta:resourcekey="lgLegendBusquedaAvanzadaResource1" /></legend>
		                <table>
		                    <tr>
		                        <td>
