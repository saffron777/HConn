...
{
	///<summary>Clase BuzonMensajeLista.</summary>
    public partial class MensajeCasoLista : PaginaListaBase, IMensajeCasoLista
	{
        int Caso;

		///<summary>Variable presentador BuzonMensajePresentadorLista.</summary>
		MensajeCasoPresentadorLista presentador;
		...
		protected void Page_Init(object sender, EventArgs e)
		{
			try
			{
				...
				presentador = new MensajeCasoPresentadorLista(this);
				Orden = "Id";
			}
			catch(Exception ex)
			{
		...
		protected void RadGridMaster_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
		{
			try
			{
				this.presentador.MostrarVista(this.Orden, this.NumeroPagina, this.TamanoPagina, this.ParametrosFiltro, Caso);
			}
			catch (Exception ex)
			{
				HConnexum.Infraestructura.Errores.ManejarError(ex, @"Error al Mostrar la data de la Aplicacion");
