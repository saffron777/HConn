<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SolicitudNuevoMovimiento_Ing.ascx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Bloques.SolicitudNuevoMovimiento_Ing" %>
...
<asp:Panel ID="pnlMovimientoDatos" runat="server" GroupingText="Datos del Movimiento" CssClass="PanelStyle">
	<table runat="server" id="T1" border="0" width="100%" class="ancho">
		...
		<tr>
			...
			<td class="fieldCell4colP" style="vertical-align: top;"><asp:TextBox ID="MontoPresup" runat="server" MaxLength="13" Width="83%" onkeypress="return Decimal(event);" /></td>
        ...
        <tr>
            <td class="fieldCell4colP" style="vertical-align: top;" width="50%" colspan="4"><asp:TextBox ID="ObsDiagnostico" runat="server" MaxLength="200" TextMode="MultiLine" Rows="5" Width="50%" Style="overflow:auto"/></td>
        </tr>
	</table>
</asp:Panel>
<asp:Panel ID="pnlDocumentos" runat="server" GroupingText="Documentos" CssClass="PanelStyle">
	<table runat="server" id="T2" border="0" width="100%" class="ancho">
		<tr>
		...
		<tr>
            <td style="vertical-align: top; width: 50%" colspan="2">
                <asp:CustomValidator ID="cvDocumentos" runat="server" ClientValidationFunction="ValidarDocumentos" CssClass="validator" ErrorMessage="* &nbsp; &nbsp; Debe seleccionar y enviar al menos un documento." ValidationGroup="Validaciones" Width="100%" />
            </td>
		</tr>
        <tr>
            <td style="vertical-align: top; width: 50%" colspan="2"><asp:Label ID="Label1" runat="server" Text="Otros Documentos" /></td>
        </tr>
	    <tr>
            <td style="vertical-align: top; width: 50%"><asp:TextBox ID="ObservacionesDocumentos" runat="server" MaxLength="200" Rows="5" TextMode="MultiLine" Width="100%" Style="overflow:auto"/><br/></td>
...
<telerik:RadInputManager ID="RadInputManager1" runat="server">
	...
	<telerik:NumericTextBoxSetting BehaviorID="BehaviorNumeric" EmptyMessage="" Validation-IsRequired="true" ErrorMessage="" DecimalDigits="2" DecimalSeparator="," Validation-ValidationGroup="Validaciones">
		<TargetControls>
...
<!-- CLAVES XML-FIN -->
<span class="arrange"><asp:HiddenField runat="server" ID="hidBloqueTipo" Value="Ingreso" /></span>
