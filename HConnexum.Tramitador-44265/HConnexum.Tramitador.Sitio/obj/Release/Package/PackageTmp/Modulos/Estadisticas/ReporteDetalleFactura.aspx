<%@ Page Title="Reporte Detalle Factura" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="ReporteDetalleFactura.aspx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Estadisticas.ReporteDetalleFactura" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
	<telerik:ReportViewer ID="ReporteDetalleFacturas" runat="server" Width="100%" 
