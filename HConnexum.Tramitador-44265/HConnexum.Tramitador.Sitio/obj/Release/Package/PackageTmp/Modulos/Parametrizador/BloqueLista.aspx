<%@ Page Title="Listado de Bloques" MasterPageFile="~/Master/Site.Master" Language="C#" AutoEventWireup="True" CodeBehind="BloqueLista.aspx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Parametrizador.BloqueLista" meta:resourcekey="PageResource1" %>
        ...
        <div style="position: relative; width: 100%; height: 100%; bottom: 0; left: 0; z-index: 1">
            <telerik:RadScriptBlock runat="server" id="RadScriptBlock1">
                <script type="text/javascript">
                    ...
                    var ventanaDetalle = "Modulos/Parametrizador/BloqueDetalle.aspx?IdMenu=" + idMenu + "&";
