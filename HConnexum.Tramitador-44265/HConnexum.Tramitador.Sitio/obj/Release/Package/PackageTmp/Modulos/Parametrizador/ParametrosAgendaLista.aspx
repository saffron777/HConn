<%@ Page Title="Agenda Para un Paso" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="True" CodeBehind="ParametrosAgendaLista.aspx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Parametrizador.ParametrosAgendaLista" meta:resourcekey="PageResource1" %>
        ...
        <div style="position: relative; width: 100%; height: 100%; bottom: 0; left: 0; z-index: 1">
            <telerik:RadScriptBlock runat="server" id="RadScriptBlock1">
                <script type="text/javascript">
                    ...
                    var ventanaDetalle = "Modulos/Parametrizador/ParametrosAgendaDetalle.aspx?IdMenu=" + idMenu + "&";
                ...
                <MasterTableView CommandItemDisplay="Top" NoMasterRecordsText="No se encontraron registros" DataKeyNames="IdEncriptado" ClientDataKeyNames="IdEncriptado" width="100%">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Nombre" 
                            FilterControlAltText="Filtrar columna Nombre"  HeaderText="NombreCito" 
                            UniqueName="Nombre" meta:resourcekey="GridBoundColumnResource2"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Cantidad" FilterControlAltText="Filtrar columna Cantidad"  
                                                 HeaderText="Cantidad" UniqueName="Cantidad" 
