<%@ Page Title="Listado de Servicios Sucursal" Language="C#" MasterPageFile="~/Master/Site.Master"  AutoEventWireup="True" CodeBehind="ServicioSucursalLista.aspx.cs" Inherits="HConnexum.Tramitador.Sitio.Modulos.Parametrizador.ServicioSucursalLista" meta:resourcekey="PageResource1" %>
        ...
        <div style="position: relative; width: 100%; height: 100%; bottom: 0; left: 0; z-index: 1">
            <telerik:RadScriptBlock runat="server" id="RadScriptBlock1">
                <script type="text/javascript">
                    ...
                    var ventanaDetalle = "Modulos/Parametrizador/ServicioSucursalDetalle.aspx?IdMenu=" + idMenu + "&";
                ...
                <MasterTableView CommandItemDisplay="Top" NoMasterRecordsText="No se encontraron registros" DataKeyNames="IdEncriptado" ClientDataKeyNames="IdEncriptado" width="100%">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Servicio" 
                                                 ...
                                                 HeaderText="Servicio" UniqueName="Servicio" 
